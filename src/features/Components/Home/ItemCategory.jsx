...
const datafirst = {
	...
	title: 'đồ uống',
	quantity: 1,
	urlImg: 'https://res.cloudinary.com/dzpks7wzs/image/upload/v1629535477/N16_ecommers/baverages-1_arlj6a.jpg',
};
			...
			<Grid container>
				<Grid style={{ width: '20%' }} item>
					<Link
						...
						to="/products"
						onClick={() => setCategory('category=' + ConvertStr(datafirst.title).replace(/\s/g, ''))}
					>
